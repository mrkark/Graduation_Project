...
class Bunkai extends Model {}

Bunkai.init(
  {
    Bunkai_ID: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
  ...
  { sequelize, modelName: 'Bunkai', tableName: 'Bunkai' }
);

module.exports = Bunkai;
